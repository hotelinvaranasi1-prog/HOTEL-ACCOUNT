    ...
    <div className="space-y-8">
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-slate-500 font-medium">Analyze performance and export data.</p>
        </div>
        
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4 bg-white p-2 rounded-[2rem] border border-slate-100 shadow-sm w-fit">
          ...
          {reportType === 'custom' && (
            <motion.div 
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-indigo-50/50 rounded-xl border border-indigo-100"
            >
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="bg-transparent text-xs font-bold outline-none text-indigo-700 w-28 cursor-pointer"
                />
              </div>
              <span className="text-indigo-300 font-black text-[10px] uppercase tracking-tighter mx-1">to</span>
              <div className="flex items-center gap-2">
                <input
                  type="date"
                  value={endDate}
